...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<vector<double> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<vector<double> >", -2, "vector", 470,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const vector<int>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("vector<int>", -2, "vector", 470,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const bitset<32>*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("bitset<32>", 2, "bitset", 668,
...
"/Users/nick/dev/root/include",
"/Users/nick/dev/packages/physics/eventStructuredAu/",
0
    };
...
nullptr};
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("TStarJetPicoRootDict",
        ...
        TriggerDictionaryInitialization_TStarJetPicoRootDict_Impl, {}, classesHeaders, /*has no C++ module*/false);
      isInitialized = true;
    }
  }
